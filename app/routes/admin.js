...
export default function AdminLayout() {
    ...
    if (checking) {
        return (_jsx("div", { className: "flex min-h-dvh items-center justify-center bg-[#F4F3F8]", children: _jsxs("div", { className: "flex flex-col items-center gap-3", children: [_jsx("div", { className: "h-8 w-8 animate-spin rounded-full border-2 border-[#6D4AFF] border-t-transparent" }), _jsx("span", { className: "text-sm text-[#6B6480]", children: "Loading\u2026" })] }) }));
    }
    if (!user)
        return null;
    return (_jsxs("div", { className: "flex min-h-dvh overflow-hidden bg-[#F4F3F8]", children: [sidebarOpen && (_jsx("div", { className: "fixed inset-0 z-20 bg-black/40 lg:hidden", onClick: () => setSidebarOpen(false), "aria-hidden": "true" })), _jsxs("aside", { className: [
                ...
                ].join(" "), "aria-label": "Main navigation", children: [_jsxs("div", { className: "flex h-16 items-center gap-3 border-b border-white/10 px-5", children: [_jsx("div", { className: "flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#6D4AFF]", children: _jsx("svg", { className: "size-4 text-white", viewBox: "0 0 24 24", fill: "none", children: _jsx("path", { d: "M4 7h16M4 12h10M4 17h7", stroke: "currentColor", strokeWidth: "2.2", strokeLinecap: "round" }) }) }), _jsxs("div", { className: "min-w-0 flex-1", children: [_jsx("div", { className: "text-sm font-bold leading-tight text-white", children: "Dupli1" }), _jsx("div", { className: "text-[10px] font-medium uppercase tracking-widest text-[#7B70A8]", children: "Admin" })] }), _jsx("button", { type: "button", onClick: () => setSidebarOpen(false), className: "rounded-lg p-2 text-[#9D98B3] transition hover:bg-white/10 hover:text-white lg:hidden", "aria-label": "Close menu", children: _jsx(CloseIcon, {}) })] }), _jsxs("nav", { className: "flex-1 overflow-y-auto px-3 py-4", children: [_jsxs("div", { className: "space-y-0.5", children: [_jsx(SidebarLink, { to: "/", icon: _jsx(DashboardIcon, {}), label: "Dashboard", exact: true, onNavigate: () => setSidebarOpen(false) }), _jsx(SidebarLink, { to: "/products", icon: _jsx(ProductsIcon, {}), label: "Products", onNavigate: () => setSidebarOpen(false) }), _jsx(SidebarLink, { to: "/orders", icon: _jsx(OrdersIcon, {}), label: "Orders", onNavigate: () => setSidebarOpen(false) }), _jsx(SidebarLink, { to: "/coupons", icon: _jsx(CouponsIcon, {}), label: "Coupons", onNavigate: () => setSidebarOpen(false) }), _jsx(SidebarLink, { to: "/analytics", icon: _jsx(AnalyticsIcon, {}), label: "Analytics", onNavigate: () => setSidebarOpen(false) }), _jsx(SidebarLink, { to: "/users", icon: _jsx(UsersIcon, {}), label: "Register", onNavigate: () => setSidebarOpen(false) })] }), _jsx("div", { className: "mt-4 border-t border-white/10 pt-4", children: _jsx(SidebarLink, { to: "/settings", icon: _jsx(SettingsIcon, {}), label: "Settings", onNavigate: () => setSidebarOpen(false) }) })] }), _jsx("div", { className: "border-t border-white/10 p-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] lg:pb-3", children: _jsxs("div", { className: "flex items-center gap-3 rounded-xl px-2 py-2", children: [_jsx("div", { className: "flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#6D4AFF]/30 text-xs font-bold text-[#B4A8FF]", children: user.email[0].toUpperCase() }), _jsxs("div", { className: "min-w-0 flex-1", children: [_jsx("p", { className: "truncate text-xs font-medium text-white", children: user.email }), _jsx("p", { className: "text-[10px] text-[#7B70A8]", children: user.role ?? "Administrator" })] }), _jsx("button", { onClick: handleLogout, title: "Sign out", className: "rounded-lg p-1.5 text-[#7B70A8] transition hover:bg-white/10 hover:text-white", children: _jsx(LogoutIcon, {}) })] }) })] }), _jsxs("div", { className: "flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden", children: [_jsxs("header", { className: "flex h-14 shrink-0 items-center gap-2 border-b border-[#E5E3EE] bg-white px-4 pt-[env(safe-area-inset-top)] sm:h-16 sm:gap-3 sm:px-5 lg:pt-0", children: [_jsx("button", { type: "button", onClick: () => setSidebarOpen(true), className: "-ml-1 rounded-lg p-2 text-[#6B6480] hover:bg-[#F4F3F8] lg:hidden", "aria-label": "Open menu", "aria-expanded": sidebarOpen, children: _jsx(HamburgerIcon, {}) }), _jsx("div", { className: "flex-1" }), _jsxs("div", { className: "flex items-center gap-2 rounded-full bg-[#F4F3F8] px-2.5 py-1.5 sm:px-3", children: [_jsx("div", { className: "h-2 w-2 rounded-full bg-emerald-500" }), _jsx("span", { className: "hidden text-xs font-medium text-[#6B6480] sm:inline", children: "Backend online" })] })] }), _jsx("main", { className: "flex-1 overflow-y-auto overscroll-y-contain [-webkit-overflow-scrolling:touch]", children: _jsx("div", { className: "mx-auto max-w-7xl p-4 sm:p-6", children: _jsx(Outlet, {}) }) })] })] }));
}
