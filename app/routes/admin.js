...
export default function AdminLayout() {
    ...
    if (checking) {
        return (_jsx("div", { className: "flex min-h-screen items-center justify-center bg-[#F4F3F8]", children: _jsxs("div", { className: "flex flex-col items-center gap-3", children: [_jsx("div", { className: "h-8 w-8 animate-spin rounded-full border-2 border-[#6D4AFF] border-t-transparent" }), _jsx("span", { className: "text-sm text-[#6B6480]", children: "Loading\u2026" })] }) }));
    }
    if (!user)
        return null;
    return (_jsxs("div", { className: "flex h-screen overflow-hidden bg-[#F4F3F8]", children: [sidebarOpen && (_jsx("div", { className: "fixed inset-0 z-20 bg-black/40 lg:hidden", onClick: () => setSidebarOpen(false) })), _jsxs("aside", { className: [
                ...
                ].join(" "), children: [_jsxs("div", { className: "flex h-16 items-center gap-3 border-b border-white/10 px-5", children: [_jsx("div", { className: "flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#6D4AFF]", children: _jsx("svg", { className: "size-4 text-white", viewBox: "0 0 24 24", fill: "none", children: _jsx("path", { d: "M4 7h16M4 12h10M4 17h7", stroke: "currentColor", strokeWidth: "2.2", strokeLinecap: "round" }) }) }), _jsxs("div", { children: [_jsx("div", { className: "text-sm font-bold leading-tight text-white", children: "Schick" }), _jsx("div", { className: "text-[10px] font-medium uppercase tracking-widest text-[#7B70A8]", children: "Admin" })] })] }), _jsxs("nav", { className: "flex-1 overflow-y-auto px-3 py-4", children: [_jsxs("div", { className: "space-y-0.5", children: [_jsx(SidebarLink, { to: "/", icon: _jsx(DashboardIcon, {}), label: "Dashboard", exact: true }), _jsx(SidebarLink, { to: "/products", icon: _jsx(ProductsIcon, {}), label: "Products" }), _jsx(SidebarLink, { to: "/orders", icon: _jsx(OrdersIcon, {}), label: "Orders" }), _jsx(SidebarLink, { to: "/coupons", icon: _jsx(CouponsIcon, {}), label: "Coupons" }), _jsx(SidebarLink, { to: "/analytics", icon: _jsx(AnalyticsIcon, {}), label: "Analytics" }), _jsx(SidebarLink, { to: "/users", icon: _jsx(UsersIcon, {}), label: "Users" })] }), _jsx("div", { className: "mt-4 border-t border-white/10 pt-4", children: _jsx(SidebarLink, { to: "/settings", icon: _jsx(SettingsIcon, {}), label: "Settings" }) })] }), _jsx("div", { className: "border-t border-white/10 p-3", children: _jsxs("div", { className: "flex items-center gap-3 rounded-xl px-2 py-2", children: [_jsx("div", { className: "flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#6D4AFF]/30 text-xs font-bold text-[#B4A8FF]", children: user.email[0].toUpperCase() }), _jsxs("div", { className: "min-w-0 flex-1", children: [_jsx("p", { className: "truncate text-xs font-medium text-white", children: user.email }), _jsx("p", { className: "text-[10px] text-[#7B70A8]", children: user.role ?? "Administrator" })] }), _jsx("button", { onClick: handleLogout, title: "Sign out", className: "rounded-lg p-1.5 text-[#7B70A8] transition hover:bg-white/10 hover:text-white", children: _jsx(LogoutIcon, {}) })] }) })] }), _jsxs("div", { className: "flex flex-1 flex-col overflow-hidden", children: [_jsxs("header", { className: "flex h-16 shrink-0 items-center gap-3 border-b border-[#E5E3EE] bg-white px-5", children: [_jsx("button", { onClick: () => setSidebarOpen(true), className: "rounded-lg p-1.5 text-[#6B6480] hover:bg-[#F4F3F8] lg:hidden", children: _jsx(HamburgerIcon, {}) }), _jsx("div", { className: "flex-1" }), _jsxs("div", { className: "flex items-center gap-2 rounded-full bg-[#F4F3F8] px-3 py-1.5", children: [_jsx("div", { className: "h-2 w-2 rounded-full bg-emerald-500" }), _jsx("span", { className: "text-xs font-medium text-[#6B6480]", children: "Backend online" })] })] }), _jsx("main", { className: "flex-1 overflow-y-auto", children: _jsx("div", { className: "mx-auto max-w-7xl p-6", children: _jsx(Outlet, {}) }) })] })] }));
}
function SidebarLink({ to, icon, label, exact, }) {
    return (_jsx(NavLink, { to: to, end: exact, className: ({ isActive }) => [
