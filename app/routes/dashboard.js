...
function PageHeader() {
    ...
    return (_jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-2xl font-bold text-[#1C1B1F]", children: "Dashboard" }), _jsx("p", { className: "mt-0.5 text-sm text-[#6B6480]", children: formatted })] }), _jsx(Link, { to: "/orders", className: "rounded-xl bg-[#6D4AFF] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-[#5A38E8] active:scale-[0.98]", children: "View all orders" })] }));
}
