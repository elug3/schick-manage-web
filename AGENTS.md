...
- Use the repository files and any `docs/`, `README.md`, `CONTRIBUTING.md`, or `ARCHITECTURE.md`. Prefer linking to those files. Architecture and API contracts live in [CLAUDE.md](CLAUDE.md).
